from util import initialize_language_model, setup_llm_chain, save_odrl_to_text, set_openai_api_key
...
def odrl_corrector(policy_description, odrl_generated, correction_report, LLMmodel):
    # gpt-3.5-turbo
