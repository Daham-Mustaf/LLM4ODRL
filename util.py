...
def set_openai_api_key():
    ...
    if not api_key:
        raise ValueError("API key is not set! peas add your OPENAI_API_KEY.")
...
def initialize_language_model(LLMmodel):
    """
    ...
    return ChatOpenAI(temperature=temperature, model=LLMmodel, verbose=verbose)
...
# Example usage
my_url = "https://www.w3.org/ns/odrl/2/ODRL22.ttl"
odrl_onto = asyncio.run(process_url_data(my_url))
print(odrl_onto)
